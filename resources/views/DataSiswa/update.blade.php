                ...
                <div class="d-flex justify-content-center p-4">
                    <div class="col-lg-10 mx-4 text-start">
                        <div class="row g-3 mb-3">
                            <div class="col-md-3">
                                @if( $student->picture )
                                    <img src="{{ asset('storage/' . $student->picture) }}" id="imgInp" class="img-thumbnail" alt="profile.jpg">
                                @else
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-7">
                                <input type="text" autocomplete="on" name="nama_siswa" id="nama_siswa" class="form-control form-control-sm @error('nama_siswa') is-invalid @enderror submit" placeholder="Reiza Nurrafi" value="{{ old('nama_siswa', $student->nama_siswa) }}" required autofocus>
                                @error('nama_siswa')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-7">
                                <input type="text" autocomplete="on" name="nama_panggilan_siswa" value="{{ old('nama_panggilan_siswa', $student->nama_panggilan_siswa) }}" class="form-control form-control-sm @error('nama_panggilan_siswa') is-invalid @enderror submit" placeholder="Reiza" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-7">
                                <select name="jenis_kelamin" class="form-select form-select-sm submit" id="jenis_kelamin">
                                    <?php $jenis_kelamin = ['Pilih salah satu', 'Pria', 'Wanita'] ?>
                                    @foreach( $jenis_kelamin as $gender )
                                        @if( $student->jenis_kelamin == $gender )
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-7">
                                <input type="number" autocomplete="on" name="ktp" id="ktp" class="form-control form-control-sm @error('ktp') is-invalid @enderror submit" value="{{ old('ktp', $student->ktp) }}" autocomplete="off" placeholder="3521515890880004" required>
                                @error('ktp')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-7">
                                <input type="email" autocomplete="on" name="email" id="email" class="form-control form-control-sm @error('email') is-invalid @enderror submit" value="{{ old('email', $student->email) }}" placeholder="example@gmail.com" required>
                                @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-4">
                                <input type="text" autocomplete="on" name="tempat_lahir" value="{{ old('tempat_lahir', $student->tempat_lahir) }}" class="form-control form-control-sm col-sm-4 @error('tempat_lahir') is-invalid @enderror submit" placeholder="Surabaya" required>
                            </div>
                            <div class="col-md-3">
                                <input type="date" name="tanggal_lahir" class="form-control form-control-sm col-sm-4 submit" value="{{ old('tanggal_lahir', $student->tanggal_lahir) }}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-7">
                                <select name="agama" id="agama" class="form-select form-select-sm">
                                    <?php $agama = ['Pilih salah satu', 'Islam', 'Protestan', 'Katolik', 'Hindu', 'Buddha', 'Khonghucu']; ?>
                                    @foreach( $agama as $kepercayaan )
                                        @if( $student->agama == $kepercayaan )
                                            <option value="{{ $kepercayaan }}" selected>{{ $kepercayaan }}</option>
                                        @else
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-5">
                                <input type="text" autocomplete="on" value="{{ old('nama_jalan_ktp', $student->nama_jalan_ktp) }}" class="form-control form-control-sm submit" id="nama_jalan_ktp" name="nama_jalan_ktp" required placeholder="Jalan Raya Kencana 1 Blok AB" required>
                            </div>
                            <div class="col-md-1">
                                <input type="number" autocomplete="on" value="{{ old('rt_ktp', $student->rt_ktp) }}" name="rt_ktp" class="form-control form-control-sm submit" id="rt_ktp" placeholder="RT" required>
                            </div>
                            <div class="col-md-1">
                                <input type="number" autocomplete="on" name="rw_ktp" value="{{ old('rw_ktp', $student->rw_ktp) }}" class="form-control form-control-sm submit" id="rw_ktp" placeholder="RW" required>
                            </div>
                        </div>
                        <div class="row g-3 mb-3">
                            <div class="col-md-3"></div>
                            <div class="col-md-3">
                                <input type="text" autocomplete="on" value="{{ old('nama_desa_ktp', $student->nama_desa_ktp) }}" class="form-control form-control-sm submit" id="nama_desa_ktp" name="nama_desa_ktp" required placeholder="Gayungan">
                            </div>
                            <div class="col-md-4">
                                <input type="text" autocomplete="on" value="{{ old('nama_kecamatan_ktp', $student->nama_kecamatan_ktp) }}" name="nama_kecamatan_ktp" class="form-control form-control-sm submit" id="nama_kecamatan_ktp" placeholder="Ketintang" required>
                            </div>
                        </div>
                        <div class="row g-3 mb-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-5">
                                <input type="text" autocomplete="on" value="{{ old('nama_jalan_domisili', $student->nama_jalan_domisili) }}" id="nama_jalan_domisili" class="form-control form-control-sm submit" name="nama_jalan_domisili" required placeholder="Jalan Raya Kencana 1 Blok AB">
                            </div>
                            <div class="col-md-1">
                                <input type="number" autocomplete="on" value="{{ old('rt_domisili', $student->rt_domisili) }}" id="rt_domisili" name="rt_domisili" class="form-control form-control-sm submit" id="rt_domisili" placeholder="RT" required>
                            </div>
                            <div class="col-md-1">
                                <input type="number" autocomplete="on" value="{{ old('rw_domisili', $student->rw_domisili) }}" id="rw_domisili" name="rw_domisili" class="form-control form-control-sm submit" id="rw_domisili" placeholder="RW" required>
                            </div>
                        </div>
                        <div class="row g-3 mb-3">
                            <div class="col-md-3"></div>
                            <div class="col-md-3">
                                <input type="text" autocomplete="on" value="{{ old('nama_desa_domisili', $student->nama_desa_domisili) }}" id="nama_desa_domisili" class="form-control form-control-sm submit" name="nama_desa_domisili" required placeholder="Gayungan">
                            </div>
                            <div class="col-md-4">
                                <input type="text" autocomplete="on" value="{{ old('nama_kecamatan_domisili', $student->nama_kecamatan_domisili) }}" id="nama_kecamatan_domisili" name="nama_kecamatan_domisili" class="form-control form-control-sm submit" id="nama_kecamatan_domisili" placeholder="Ketintang" required>
                            </div>
                        </div>
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-sm-7">
                                <select name="tempat_tinggal" id="tempat_tinggal" class="form-select form-select-sm submit" required>
                                    <?php $tempat_tinggal = ['Pilih salah satu', 'Bersama Orang Tua', 'Kost', 'Rumah Pribadi', 'Lainnya'] ?>
                                    @foreach( $tempat_tinggal as $tinggal )
                                        @if( $student->tempat_tinggal == $tinggal )
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-sm-7">
                                <select name="transportasi" id="transportasi" class="form-select form-select-sm submit" required>
                                    <?php $transportasi = ['Pilih salah satu', 'Sepeda Motor', 'Angkutan Umum', 'Jalan Kaki', 'Lainnya'] ?>
                                    @foreach( $transportasi as $transport )
                                        @if( $student->transportasi == $transport )
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-sm-7">
                                <input type="number" autocomplete="on" value="{{ old('no_hp', $student->no_hp) }}" name="no_hp" id="no_hp" class="form-control form-control-sm submit" placeholder="085xxxxxxxxx" required>
                            </div>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-3">
                                <input type="text" autocomplete="on" value="{{ old('asal_sekolah', $student->asal_sekolah) }}" name="asal_sekolah" id="asal_sekolah" class="form-control form-control-sm submit" placeholder="SMAN 1 HARAPAN BARU" required>
                            </div>
                            <div class="col-md-4">
                                <input type="text" autocomplete="on" value="{{ old('kota_asal_sekolah', $student->kota_asal_sekolah) }}" name="kota_asal_sekolah" class="form-control form-control-sm submit" id="kota_asal_sekolah" placeholder="Surabaya" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <select name="pic_id" class="form-select form-select-sm submit" id="pic_id">
                                    ...
                                    @foreach( $pics as $pic )
                                        @if( $pic->id === $i )
                                            <option value="{{ $i }}" selected>{{ $pic->nama_pic }}</option>
                                        @else
                                            <option value="{{ $i }}">{{ $pic->nama_pic }}</option>
                                        @endif
                                        <?php $i++; ?>
                                    @endforeach
                                </select>
                        ...
                        <input type="hidden" name="tahun_daftar" class="@error('tahun_daftar') is-invalid @enderror form-control" id="tahun_daftar" placeholder="tahun_daftar" style="border-radius: 0px 0px 0px 0px; margin-bottom: -1px;" value="{{ $student->tahun_daftar }}"  required>
                        <input type="hidden" name="password" class="@error('password') is-invalid @enderror form-control" id="password" placeholder="password" style="border-radius: 0px 0px 0px 0px; margin-bottom: -1px;" value="{{ $student->password }}"  required>
                    </div>
        ...
        <div class="card col-lg-12">
            ...
            <div class="card-body text-start p-4" style="margin-left: 50px;">
                <div class="row g-3 mt-3 mb-3">
                    ...
                    <div class="col-md-4">
                        <input type="text" autocomplete="on" name="nama_ayah" value="{{ old('nama_ayah', $student->nama_ayah) }}" id="nama_ayah" class="form-control form-control-sm submit" placeholder="Nama Ayah" required>
                    </div>
                    <div class="col-md-3">
                        <input type="text" autocomplete="on" name="nama_ibu" value="{{ old('nama_ibu', $student->nama_ibu) }}" id="nama_ibu" class="form-control form-control-sm submit" placeholder="Nama Ibu" required>
                    </div>
                </div>
                <div class="row g-3 mb-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4">
                        <input type="date" name="tanggal_lahir_ayah" value="{{ old('tanggal_lahir_ayah', $student->tanggal_lahir_ayah) }}" id="tanggal_lahir_ayah" class="form-control form-control-sm submit" >
                    </div>
                    <div class="col-md-3">
                        <select name="pendidikan_ayah" id="pendidikan_ayah" class="form-select form-select-sm submit" required>
                            <?php $pendidikan_ayah = ['Pilih salah satu', 'SD', 'SMP', 'SLTA/SEDERAJAT', 'S1', 'S2', 'S3']; ?>
                            @foreach( $pendidikan_ayah as $p_ayah )
                                @if( $student->pendidikan_ayah == $p_ayah )
                                    <option value="{{ $p_ayah }}" selected>{{ $p_ayah }}</option>
                                @else
                                    <option value="{{ $p_ayah }}">{{ $p_ayah }}</option>
                                @endif
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-4">
                        <input type="date" name="tanggal_lahir_ibu" value="{{ old('tanggal_lahir_ibu', $student->tanggal_lahir_ibu) }}" id="tanggal_lahir_ibu" class="form-control form-control-sm submit" required>
                    </div>
                    <div class="col-md-3">
                        <select name="pendidikan_ibu" id="pendidikan_ibu" class="form-select form-select-sm submit" required>
                            <?php $pendidikan_ibu = ['Pilih salah satu', 'SD', 'SMP', 'SLTA/SEDERAJAT', 'S1', 'S2', 'S3']; ?>
                            @foreach( $pendidikan_ibu as $p_ibu )
                                @if( $student->pendidikan_ibu == $p_ibu )
                                    <option value="{{ $p_ibu }}" selected>{{ $p_ibu }}</option>
                                @else
                                    <option value="{{ $p_ibu }}">{{ $p_ibu }}</option>
                                @endif
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-4">
                        <input type="text" autocomplete="on" value="{{ old('pekerjaan_ayah', $student->pekerjaan_ayah) }}" name="pekerjaan_ayah" placeholder="Swasta" id="pekerjaan_ayah" class="form-control form-control-sm submit" required>
                    </div>
                    <div class="col-md-3">
                        <input type="text" autocomplete="on" value="{{ old('pekerjaan_ibu', $student->pekerjaan_ibu) }}" name="pekerjaan_ibu" placeholder="Swasta" id="pekerjaan_ibu" class="form-control form-control-sm submit" required>
                    </div>
                </div>
                <div class="row g-3 mb-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4">
                        <input type="number" autocomplete="on" value="{{ old('penghasilan_ayah', $student->penghasilan_ayah) }}" name="penghasilan_ayah" placeholder="Penghasilan perbulan" id="penghasilan_ayah" class="form-control form-control-sm submit" required>
                    </div>
                    <div class="col-md-3">
                        <input type="number" autocomplete="on" value="{{ old('penghasilan_ibu', $student->penghasilan_ibu) }}" name="penghasilan_ibu" placeholder="Penghasilan perbulan" id="penghasilan_ibu" class="form-control form-control-sm submit" required>
                    </div>
                </div>
                <div class="row g-3 mb-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4">
                        <input type="text" autocomplete="on" value="{{ old('keterangan_ayah', $student->keterangan_ayah) }}" name="keterangan_ayah" placeholder="Masih Hidup / Meninggal" id="keterangan_ayah" class="form-control form-control-sm submit" required>
                    </div>
                    <div class="col-md-3">
                        <input type="text" autocomplete="on" value="{{ old('keterangan_ibu', $student->keterangan_ibu) }}" name="keterangan_ibu" placeholder="Masih Hidup / Meninggal" id="keterangan_ibu" class="form-control form-control-sm submit" required>
                    </div>
                </div>
                <div class="row g-3 mb-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-5">
                        <input type="text" autocomplete="on" value="{{ old('nama_jalan_ortu', $student->nama_jalan_ortu) }}" id="nama_jalan_ortu" class="form-control form-control-sm submit" name="nama_jalan_ortu" required placeholder="Jalan Raya Kencana 1 Blok AB">
                    </div>
                    <div class="col-md-1">
                        <input type="number" autocomplete="on" value="{{ old('rt_ortu', $student->rt_ortu) }}" id="rt_ortu" name="rt_ortu" class="form-control form-control-sm submit" id="rt_ortu" placeholder="RT" required>
                    </div>
                    <div class="col-md-1">
                        <input type="number" autocomplete="on" id="rw_ortu" value="{{ old('rw_ortu', $student->rw_ortu) }}" name="rw_ortu" class="form-control form-control-sm submit" id="rw_ortu" placeholder="RW" required>
                    </div>
                </div>
                <div class="row g-3 mb-3">
                    <div class="col-md-3"></div>
                    <div class="col-md-3">
                        <input type="text" autocomplete="on" value="{{ old('nama_desa_ortu', $student->nama_desa_ortu) }}" id="nama_desa_ortu" class="form-control form-control-sm submit" name="nama_desa_ortu" required placeholder="Gayungan" required>
                    </div>
                    <div class="col-md-4">
                        <input type="text" autocomplete="on" value="{{ old('nama_kecamatan_ortu', $student->nama_kecamatan_ortu) }}" id="nama_kecamatan_ortu" name="nama_kecamatan_ortu" class="form-control form-control-sm submit" id="nama_kecamatan_ortu" placeholder="Ketintang" required>
                    </div>
                </div>
        ...
        <div class="card col-lg-12">
            ...
            <div class="card-body p-4 text-start" style="margin-left: 50px;">
                <div class="row mb-3 mt-3">
                    ...
                    <div class="col-sm-6">
                        <input type="number" autocomplete="on" value="{{ old('tinggi_badan', $student->tinggi_badan) }}" name="tinggi_badan" id="tinggi_badan" placeholder="Tinggi Badan" class="form-control form-control-sm submit" required>
                    </div>
                ...
                <div class="row mb-3 mt-3">
                    ...
                    <div class="col-sm-6">
                        <input type="number" autocomplete="on" value="{{ old('jarak_tempuh_sekolah', $student->jarak_tempuh_sekolah) }}" name="jarak_tempuh_sekolah" id="jarak_tempuh_sekolah" placeholder="Jarak Tempuh" class="form-control form-control-sm submit" autofocus required>
                    </div>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-2">
                        <input type="number" autocomplete="on" value="{{ old('urutan_anak', $student->urutan_anak) }}" name="urutan_anak" id="urutan_anak" class="form-control form-control-sm submit" placeholder="1" required>
                    </div>
                    <div class="col-md-1">
