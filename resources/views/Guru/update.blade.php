        ...
        <div class="card">
            <form action="/teacher-update/{{ $teacher->id }}" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="form-floating mb-1">
                        <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" placeholder="username" value="{{ old('username', $teacher->username) }}" required>
